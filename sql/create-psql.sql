...
CREATE TABLE ChessdUser (
	chessduserid	SERIAL PRIMARY KEY,
	adminlevel		INTEGER,
	deleted			BOOLEAN,
...
CREATE TABLE UserCommandAlias (
	usercommandaliasid 	SERIAL PRIMARY KEY,
	ownerid				INTEGER,
	alias				TEXT,
	targetcommand		TEXT,
...
CREATE TABLE UserCensor (
	usercensorid		SERIAL PRIMARY KEY,
	ownerid				INTEGER,
...
CREATE TABLE UserFollow (
	userfollowid		SERIAL PRIMARY KEY,
	ownerid				INTEGER,
	targetuser			VARCHAR(50),
	targetuserid		INTEGER,
...
CREATE TABLE UserNoPlay (
	usernoplayid		SERIAL PRIMARY KEY,
	ownerid				INTEGER,
	targetuser			VARCHAR(50),
	targetuserid		INTEGER,
...
CREATE TABLE UserGNotify (
	usergnotifyid		SERIAL PRIMARY KEY,
	ownerid				INTEGER,
	targetuser			VARCHAR(50),
	targetuserid		INTEGER,
...
CREATE TABLE UserNotify (
	usernotifyid		SERIAL PRIMARY KEY,
	ownerid				INTEGER,
	targetuser			VARCHAR(50),
	targetuserid		INTEGER,
...
CREATE TABLE UserChannel (
	userchannelid		SERIAL PRIMARY KEY,
	ownerid				INTEGER,
	channel				INTEGER,
...
CREATE TABLE UserLogon (
	userlogonid			SERIAL PRIMARY KEY,
	userid				INTEGER,
	islogin				BOOLEAN, /* if it is not a login, then it is a logout*/
	eventtime			TIMESTAMP,
	fromip				VARCHAR(16),
...
CREATE TABLE Message (
	...
	lastposttime		TIMESTAMP WITHOUT TIME ZONE DEFAULT now()
...
CREATE TABLE ConfigVariable (
	configvariableid	SERIAL PRIMARY KEY,
	name				varchar(64),
	enumvalue			integer,
...
CREATE TABLE serverEvent (
	servereventid	SERIAL PRIMARY KEY,
	eventtype		INTEGER,
		/*
			0: server start
			1: server shutdown
...
CREATE TABLE ServerMessage (
    servermessageid	serial NOT NULL PRIMARY KEY,
...
CREATE TABLE PageConfigVariable (
    pageconfigvariableid SERIAL PRIMARY KEY,
    name				VARCHAR(128),
    value				TEXT
);

CREATE TABLE AdminActionLog (
	adminactionlogid	SERIAL PRIMARY KEY,
	action_type			INTEGER,
	fromuserid			INTEGER,
	fromname			VARCHAR(50),
...
CREATE TABLE uservariable (
    uservaribleid	SERIAL PRIMARY KEY,
    varibleid		INTEGER,
    varname			VARCHAR(50),
    value			VARCHAR(50),
    accesslevel		INTEGER,
